...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showPilotBanner && (
        <div className="flex items-start justify-between gap-3 bg-amber-50 border border-amber-200 rounded-2xl px-4 py-3 text-amber-800">
          <div className="space-y-1">
            <p className="text-xs font-semibold">
              🧪 Bu panel TheraGift pilot demo ortamındadır. Görüntülenen veriler test amaçlıdır — lütfen gerçek danışan bilgisi girmeyin.
            </p>
            <p className="text-[11px] font-medium text-amber-800/80">
              TheraGift tanı, tedavi veya terapi hizmeti vermez; yalnızca operasyonel yönetim panelidir.
            </p>
          </div>
          <button
            type="button"
      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard label="Kullanım Kotası" value={`${summary.aiQuotaUsed} / ${summary.aiQuotaLimit}`} hint="Kullanılan / toplam hak" />
        </div>
      </div>
